...
main.pdf: main.tex references.bib figure-data.tex catalog-data.tex figures/corpus-evidence-body.tex $(FIGURE_PDFS) $(wildcard figures/*.png) Makefile
...
arxiv: main.pdf
	...
	cp main.tex main.bbl figure-data.tex catalog-data.tex build/arxiv/
