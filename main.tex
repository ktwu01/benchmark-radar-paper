...
\hypersetup{
  ...
  pdfauthor={Koutian Wu, Junjie Zhou, Ergan Shang, Jiayu Wang, Pengqian Han, and Wanghan Xu}
}
...
\author{Koutian Wu$^{1,2}$ \footnote{\small Corresponding author: \href{mailto:k@tacite.ai}{k@tacite.ai}} \quad Junjie Zhou$^3$ \quad Ergan Shang$^4$ \quad Jiayu Wang$^5$ \quad Pengqian Han$^6$ \quad Wanghan Xu$^7$\\[0.35em]
...
\small $^7$ Shanghai Jiao Tong University
}
\date{}
