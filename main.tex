...
The Transformer architecture established attention-based sequence modeling as a foundation for modern large language models (LLMs) \citep{vaswani2017attention}. Model families such as GPT-4 and Claude Sonnet span changing capabilities and deployment settings \citep{openai2023gpt4,anthropic2025claude37sonnetcode}. Comparing these models requires benchmarks that expose failures and distinguish capability gains from changes in prompts, data splits, or evaluation procedures \citep{hendrycks2021mmlu,rein2023gpqa,phan2025hle,shang2026llm}.
