...
\author{Koutian Wu\thanks{Earth-Space-AI; Tacite AI. Corresponding author: \href{mailto:k@tacite.ai}{k@tacite.ai}}}
\author{Junjie Zhou\thanks{Hangzhou Dianzi University}}
\author{Ergan Shang\thanks{Carnegie Mellon University}}
\author{Jiayu Wang\thanks{Xi'an Jiaotong University}}
\author{Pengqian Han\thanks{The University of Auckland}}
\author{Junkai Wang\thanks{Tsinghua University}}
\author{Wanghan Xu\thanks{Shanghai Jiao Tong University}}
\author{Songyuanyi Lu\thanks{The University of Hong Kong}}
\author{Lin Shi\thanks{Cornell Tech}}
\makeatletter
\def\@author{Koutian Wu$^{1,2}$ \footnote{\small Corresponding author: \href{mailto:k@tacite.ai}{k@tacite.ai}} \quad Junjie Zhou$^3$ \quad Ergan Shang$^4$ \quad Jiayu Wang$^5$\\[-0.05em]
\quad Pengqian Han$^6$ \quad Junkai Wang$^7$ \quad Wanghan Xu$^8$ \quad Songyuanyi Lu$^9$ \quad Lin Shi$^{10}$\\[0.35em]
\parbox{\textwidth}{\centering\fontsize{6.5}{7.5}\selectfont $^1$ Earth-Space-AI\hspace{0.1em}
$^2$ Tacite AI\hspace{0.1em}
$^3$ Hangzhou Dianzi University\hspace{0.1em}
$^4$ Carnegie Mellon University\hspace{0.1em}
$^5$ Xi'an Jiaotong University\\[0.1em]
$^6$ The University of Auckland\hspace{0.1em}
$^7$ Tsinghua University\hspace{0.1em}
$^8$ Shanghai Jiao Tong University\hspace{0.1em}
$^9$ The University of Hong Kong\hspace{0.1em}
\mbox{$^{10}$ Cornell Tech}
}
}
\makeatother
\date{}
