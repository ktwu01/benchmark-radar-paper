...
\hypersetup{
  ...
  pdfauthor={Koutian Wu, Junjie Zhou, Ergan Shang, Jiayu Wang, Pengqian Han, Junkai Wang, Wanghan Xu, and Lin Shi}
}
...
\quad Pengqian Han$^6$ \quad Junkai Wang$^7$ \quad Wanghan Xu$^8$ \quad Lin Shi$^9$\\[0.35em]
